...
public class TriAuteur implements ActionListener {
   
    JButton button;
    JPanel container;
    ArrayList<Morceau> morceau;
   
    public TriAuteur(JButton button, JPanel container, ArrayList<Morceau> morceau) {
        this.button = button;
    ...
    public void actionPerformed(ActionEvent e) {
        Collections.sort(morceau, new Comparator<Morceau>() {
            ...
            public int compare(Morceau m1, Morceau m2) {
                return m1.getAuteur().compareTo(m2.getAuteur());
            }
        });
        container.removeAll();
